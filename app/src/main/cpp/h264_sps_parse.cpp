...
extern "C"
JNIEXPORT void JNICALL Java_co_jp_snjp_x264demo_hardware_H264SPSPaser_parseSps
(JNIEnv *env, jobject instance, jbyteArray sps, jint len, jint width, jint height){
    h264_decode_sps(sps,len,width,height,30);
}